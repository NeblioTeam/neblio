...
pkg_config_path = os.path.join(build_dir, 'curl_build/lib/pkgconfig/')
openssl_include_path = os.path.join(build_dir, '/openssl_build/include/')
openssl_lib_path = os.path.join(build_dir, 'openssl_build/lib/')
