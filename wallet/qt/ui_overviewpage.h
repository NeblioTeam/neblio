...
public:
    ...
    QProgressBar* wallet_blockchain_rescan_progress;
    QLabel*       wallet_blockchain_rescan_label;
    QHBoxLayout*  wallet_blockchain_rescan_layout;
    ...
    void setupUi(QWidget* OverviewPage)
    {
        ...
        left_logo_pix =
            left_logo_pix.scaledToHeight(OverviewPage->height() * 3. / 4., Qt::SmoothTransformation);
        ...
        bottom_logo_pix = bottom_logo_pix.scaledToHeight(
            OverviewPage->height() / bottom_bar_downscale_factor, Qt::SmoothTransformation);
        ...
        spendable_value_label->setTextInteractionFlags(
        ...
        stake_value_label->setTextInteractionFlags(
            Qt::LinksAccessibleByMouse | Qt::TextSelectableByKeyboard | Qt::TextSelectableByMouse);
        ...
        unconfirmed_value_label->setTextInteractionFlags(
            Qt::LinksAccessibleByMouse | Qt::TextSelectableByKeyboard | Qt::TextSelectableByMouse);
        ...
        immature_value_label->setTextInteractionFlags(
            Qt::LinksAccessibleByMouse | Qt::TextSelectableByKeyboard | Qt::TextSelectableByMouse);
        ...
        total_value_label->setTextInteractionFlags(
            Qt::LinksAccessibleByMouse | Qt::TextSelectableByKeyboard | Qt::TextSelectableByMouse);

        verticalLayout->addWidget(total_value_label);

        wallet_blockchain_rescan_label    = new QLabel("Rescan progress: ", wallet_contents_frame);
        wallet_blockchain_rescan_progress = new QProgressBar(wallet_contents_frame);
        wallet_blockchain_rescan_layout   = new QHBoxLayout;
        verticalLayout->addLayout(wallet_blockchain_rescan_layout);
        wallet_blockchain_rescan_layout->addWidget(wallet_blockchain_rescan_label);
        wallet_blockchain_rescan_layout->addWidget(wallet_blockchain_rescan_progress);
    ...
    void retranslateUi(QWidget* OverviewPage)
    {
        ...
        recent_tx_label->setText(
            QApplication::translate("OverviewPage", "<b>Recent transactions</b>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(
            QApplication::translate("OverviewPage",
...
#ifndef QT_NO_TOOLTIP
        spendable_value_label->setToolTip(
            QApplication::translate("OverviewPage", "Your current spendable balance", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        stake_title_label->setText(QApplication::translate("OverviewPage", "Stake:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        stake_value_label->setToolTip(QApplication::translate(
            "OverviewPage",
            "Total number of tokens that were staked, and do not yet count toward the current balance",
            Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        unconfirmed_title_label->setText(
            QApplication::translate("OverviewPage", "Unconfirmed:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        unconfirmed_value_label->setToolTip(
            QApplication::translate("OverviewPage",
                                    "Total of transactions that have yet to be confirmed, and do not "
                                    "yet count toward the current balance",
                                    Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        immature_title_label->setText(QApplication::translate("OverviewPage", "Immature:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        immature_value_label->setToolTip(QApplication::translate(
            "OverviewPage", "Mined balance that has not yet matured", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelTotalText->setText(QApplication::translate("OverviewPage", "Total:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        total_value_label->setToolTip(
            QApplication::translate("OverviewPage", "Your current total balance", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    }  // retranslateUi
};
