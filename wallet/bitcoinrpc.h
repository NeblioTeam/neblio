...
extern json_spirit::Value cancelvotesatblockheightrange(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value cancelvotesadjacenttoheight(const json_spirit::Array& params, bool fHelp);
