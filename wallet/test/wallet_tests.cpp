...
TEST(wallet_tests, coin_selection_tests)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        EXPECT_TRUE(!wallet.SelectCoinsMinConf( 1 * CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet, nValueRet));
        ...
        EXPECT_TRUE(!wallet.SelectCoinsMinConf( 3 * CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet, nValueRet));

        // we can make 3 cents of new  coins
        EXPECT_TRUE( wallet.SelectCoinsMinConf( 3 * CENT, GetAdjustedTime(), 1, 1, vCoins, setCoinsRet, nValueRet));
        ...
        EXPECT_TRUE(!wallet.SelectCoinsMinConf(38 * CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet, nValueRet));
        // we can't even make 37 cents if we don't allow new coins even if they're from us
        EXPECT_TRUE(!wallet.SelectCoinsMinConf(38 * CENT, GetAdjustedTime(), 6, 6, vCoins, setCoinsRet, nValueRet));
        // but we can make 37 cents if we accept new coins from ourself
        EXPECT_TRUE( wallet.SelectCoinsMinConf(37 * CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet, nValueRet));
        EXPECT_EQ(nValueRet, 37 * CENT);
        // and we can make 38 cents if we accept all new coins
        EXPECT_TRUE( wallet.SelectCoinsMinConf(38 * CENT, GetAdjustedTime(), 1, 1, vCoins, setCoinsRet, nValueRet));
        ...
        EXPECT_TRUE( wallet.SelectCoinsMinConf(71 * CENT, GetAdjustedTime(), 1, 1, vCoins, setCoinsRet, nValueRet));
        EXPECT_TRUE(!wallet.SelectCoinsMinConf(72 * CENT, GetAdjustedTime(), 1, 1, vCoins, setCoinsRet, nValueRet));
        ...
        // test randomness
        {
            ...
            EXPECT_TRUE(wallet.SelectCoinsMinConf(50 * COIN, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet , nValueRet));
            EXPECT_TRUE(wallet.SelectCoinsMinConf(50 * COIN, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet2, nValueRet));
            ...
            for (int i = 0; i < RANDOM_REPEATS; i++)
            {
                ...
                EXPECT_TRUE(wallet.SelectCoinsMinConf(COIN, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet , nValueRet));
                EXPECT_TRUE(wallet.SelectCoinsMinConf(COIN, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet2, nValueRet));
            ...
            for (int i = 0; i < RANDOM_REPEATS; i++)
            {
                // selecting 1 from 100 identical coins depends on the shuffle; this test will fail 1% of the time
                // run the test RANDOM_REPEATS times and only complain if all of them fail
                EXPECT_TRUE(wallet.SelectCoinsMinConf(90*CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet , nValueRet));
                EXPECT_TRUE(wallet.SelectCoinsMinConf(90*CENT, GetAdjustedTime(), 1, 6, vCoins, setCoinsRet2, nValueRet));
                if (equal_sets(setCoinsRet, setCoinsRet2))
                    fails++;
            }
            EXPECT_NE(fails, RANDOM_REPEATS);
