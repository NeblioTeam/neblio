...
void RunCrossPlatformSerializationTests()
{
    ...
    CScript ntp1TxOutScript;
    std::copy(cScriptPubKey.cbegin(), cScriptPubKey.cend(), std::back_inserter(ntp1TxOutScript));

    NTP1TxOut ntp1TxOut;
    ntp1TxOut.setNValue(0x12345678);            // int64_t
    ntp1TxOut.setScriptPubKey(ntp1TxOutScript); // CScript
...

    {
        ...
        ss << ntp1TxOut;
        TEST_EQUALITY(boost::algorithm::hex(ss.str()),
                      "785634120000000006616263646566010761626364656667093330353431393839362457133535341"
                      "2682457137856341288776655444222116824571378563412006824571378563412000000000A6162"
                      "626364646565666705414243444506414243444546",
                      __LINE__);
    }
                                ...
                                0x1234567813572468, NTP1TxType_TRANSFER);
    {
        ...
        TEST_EQUALITY(
            boost::algorithm::hex(ss.str()),
            "7856341268245713785634122457133535341268245713785634128877665544422211682457137856341200012"
            "45713353534126824571378563412887766554442221168245713785634120078563412314F505F4E4F50204F50"
            "5F564552204F505F4946204F505F4E4F544946204F505F5645524946204F505F5645524E4F54494668245713785"
            "6341201076162636465666709333035343139383936245713353534126824571378563412887766554442221168"
            "24571378563412006824571378563412000000000A6162626364646565666705414243444501785634120000000"
            "0066162636465660107616263646566670933303534313938393624571335353412682457137856341288776655"
            "444222116824571378563412006824571378563412000000000A616262636464656566670541424344450641424"
            "3444546682457137856341203000000",
            __LINE__);
    }
