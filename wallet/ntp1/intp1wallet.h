...
public:
    ...
    virtual std::string                           getTokenNameFromIndex(int index) const            = 0;
    ...
    virtual std::string                           getAndCacheTokenIcon(int index)                   = 0;
...
using NTP1WalletPtr = boost::shared_ptr<INTP1Wallet>;
